...
namespace ShoppingBLLibrary.Tests
{
    ...
    public class CartItemBLTests
    {
        ...
        public void AddCartItem_WhenCalled_AddsCartItemToRepository()
        {
            ...
            _cartItemRepositoryMock.Verify(r => r.Add(cartItem), Times.Once);
        }
        ...
        {
            var cartItem = new CartItem();
            _cartItemBL.UpdateCartItem(cartItem);
            _cartItemRepositoryMock.Verify(r => r.Update(cartItem), Times.Once);
        }
