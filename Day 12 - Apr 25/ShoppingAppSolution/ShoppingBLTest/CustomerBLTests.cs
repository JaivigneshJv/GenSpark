...
namespace ShoppingBLLibrary.Tests
{
    ...
    public class CustomerBLTests
    {
        ...
        public void AddCustomer_WhenCalled_AddsCustomerToRepository()
        {
            ...
            _customerRepositoryMock.Verify(r => r.Add(customer), Times.Once);
        }
        ...
        {
            var customer = new Customer();
            _customerBL.UpdateCustomer(customer);
            _customerRepositoryMock.Verify(r => r.Update(customer), Times.Once);
        }
    }
}
